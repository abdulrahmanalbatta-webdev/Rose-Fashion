...
function previewImage(event, idName) {
    ...
    reader.onload = function (e) {
        const previewCard = document.getElementById(`imgpreview-${idName}`);
        const previewImg = document.getElementById(`previewImg-${idName}`);
        const fileName = document.getElementById(`file-name-${idName}`);
