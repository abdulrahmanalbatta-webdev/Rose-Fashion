                            ...
                            <div class="col-md-8">
                                <div class="col-md-6">
                                    <div class="star-rating">
                                        <input type="radio" id="star-1" class="checked-label" name="rating"
                                            value="1">
                                        <label for="star-1"><i class="fa fa-star"></i></label>
                                        <input type="radio" id="star-2" class="checked-label" name="rating"
                                            value="2">
                                        <label for="star-2"><i class="fa fa-star"></i></label>
                                        <input type="radio" id="star-3" class="checked-label" name="rating"
                                            value="3">
                                        <label for="star-3"><i class="fa fa-star"></i></label>
                                        <input type="radio" id="star-4" class="checked-label" name="rating"
                                            value="4">
                                        <label for="star-4"><i class="fa fa-star"></i></label>
                                        <input type="radio" id="star-5" class="checked-label" name="rating"
                                            value="5">
